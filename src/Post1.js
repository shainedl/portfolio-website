...
function Post1(props) {
  ...
  return (
    <div>
      ...
      <div className="post">
        <h2>Cornell Tech Masters Degree in Computer Science</h2>
        <h3>A Guide for Prospective Students</h3>
        <h3>May 27, 2020</h3>
        <p>I graduated from Cornell Tech a year ago with a Masters in Computer Science. During my time there, I was a Student Ambassador and led tours and panels for prospective students. Since then, a handful of prospectives reached out to me to ask questions. I would like to answer their most common questions. I had a great experience at Cornell Tech, and I would to share it with you!</p>
        ...
        <h3>What if I didn't major in Computer Science in undergrad?</h3>
        <p>I majored in Operations Research concentrating in Engineering Management Systems in college and took 3 Computer Science classes. I personally felt the disadvantage to be manageable, and I felt a little more advantaged in the Machine Learning courses. </p>
        <p>I had never programmed in Python beforehand which is the programming language used in most of the classes. I spent the first few months of school googling 'I did this thing in R. What is the Python equivalent?' The first time I had to submit an assignment using Git, I freaked out because I thought I deleted all my work. Luckily, my brother fixed it for me in about 2 seconds. These are not things the professors will teach in you in class. I would recommend asking your fellow classmates questions and partnering with someone in the homeworks who has more experience. I often felt embarrassed when I didn't already know these things which made it difficult to ask questions, but it was always useful when I did. I would warn that if it's a lot easier for them that they might try to take over the assignment. I would recommend talking with your partners before you get to work about how you plan to divide the assignments, work in the same room, and update each other about your progress. </p>
        <p>The only class I felt put in a disadvantage, and I heard other people who did not major in Computer Science say they felt similarly, is Algorithms and Data Structures. For this course I would recommend a ton of practice problems. The flip side of going to such a new school is disorganization and making it up as you go. When asked for practice problems, the teacher responded that the midterm was not even made yet let alone practice problems. Therefore, if you are not too familiar with algorithms, I would recommend spending some time beforehand learning and practicing. </p>
        <p>I have directly heard someone from admissions say that they look for Linear Algebra knowledge. If you don't have that on your transcript, you should take an online course and mention it in your application. Linear Algebra is the foundation of a lot of computer science. I used this <a href="http://cs229.stanford.edu/section/cs229-linalg.pdf">Linear Algebra review</a> as a helpful refresher.</p>
        
        <h3>Are there any scholarships?</h3>
        <p>I was afforded 2 scholarships. One was a merit-based scholarship that Cornell Tech offered me along with my acceptance. This did not require a separate scholarship application. The other was through Women in Technology and Entrepreneurship in New York (WiTNY). They offer 3 scholarships each year to those that identify as women and are in the Computer Science, Operation Research, and Electrical Engineering programs specifically for Cornell Tech. They send you an application after you apply. I am not sure how applying at later rounds affects the likelihood of getting a scholarship. </p>

        <h3>What is WiTNY?</h3>
        <p>I would definitely recommend everyone get involved with Women in Technology and Entrepreneurship in New York (WiTNY) now known as Break Through Tech! There are events for women on campus and ways to volunteer to help CUNY students. I continue to volunteer by helping CUNY women with resume reviews. <b>You do not have to be a woman to mentor women.</b> Given that tech is mostly composed of men, it is imperative that men serve as mentors. When I went to CT, the Computer Science program was only 25% women. Though typical of tech, it sucks! Especially in a small school, I was often the only woman in a room. I encourage women to apply, and we can all work togehter to make the field more inclusive!</p>

        <h3>How much experience do students typically have coming into the program?</h3>
        <p>I had two years of work experience prior to starting which I believe to be true for most Computer Science students. I am personally glad that I took a couple years after undergrad. It helped me realize what I was looking for out of the program and make the most of my time there. There were people from straight out of college through 5 years out. Wherever you're at, you'll be just fine and there will be others like you!  </p>

        <h3>I'm going! How do I make the best of my experience?</h3>
        <p>Best advice that I didn't take: connect with your professors. Go into office hours early on in the semester and introduce yourself. I participated a lot in class so eventually most of them knew me, but I wish that I made more of an effort. I know grad school is already time-consuming but talk to a professor of a subject you find interesting about research opportunities. </p>
        <p>During orientation, I remember an alum giving advice about starting to work on Startup Studio as soon as possible. I don't think it's necessary to start working on a product early on, but I wish I got a head start on teaming. Teaming is where you come together with other people and decide that you want to team up for Startup Studio. It is a surprisingly long process. I mostly met other Computer Science people. I would recommend trying to meet MBAs early on. There is a stereotype that since MBAs are together in Ithaca for the summer that they are cliquey. That can be intimidating! </p>
        <p>Overall, I would recommend trying to meet and get to know as many people as possible. As an introvert, I had to push myself to do this. This is a great thing about living in the House. If you want to hang out with people, you can go up to the roof, and if you want to be alone, you are an elevator ride away from your apartment! Also, it's another reason I am glad I chose Computer Science. Computer Science and MBA are the two largest programs at Cornell Tech, and some of the others have 10 to 15 people. So, I think socially it's a good call. </p>
        <p>Congratulations! I am excited for you!</p>
